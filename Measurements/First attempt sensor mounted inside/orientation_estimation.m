...
for i = 1:4
    ...
    figure(i)
    eval(sprintf('subplot(3,2,1); plot(old%i(2,:)); hold on; plot(imu%i_raw(2,1:1000));',i,i))
    eval(sprintf('subplot(3,2,3); plot(old%i(3,:)); hold on; plot(imu%i_raw(3,1:1000));',i,i))
    eval(sprintf('subplot(3,2,5); plot(old%i(4,:)); hold on; plot(imu%i_raw(4,1:1000));',i,i))
    eval(sprintf('subplot(3,2,2); plot(old%i(5,:)); hold on; plot(imu%i_raw(5,1:1000));',i,i))
    eval(sprintf('subplot(3,2,4); plot(old%i(6,:)); hold on; plot(imu%i_raw(6,1:1000));',i,i))
    eval(sprintf('subplot(3,2,6); plot(old%i(7,:)); hold on; plot(imu%i_raw(7,1:1000));',i,i))
end
